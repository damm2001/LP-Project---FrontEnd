...
export class EjerciciosSerService {
   //Atributo URL
   private URL: string = 'http://127.0.0.1:4567/api/studentsbooks';
  ...
  getResponse(): Observable<any> {
    ...
    const headers = new HttpHeaders({
      ...
      'Access-Control-Allow-Origin': 'http://localhost:4200/about'  // Cambia esto con el origen de tu aplicación Angular
    });
